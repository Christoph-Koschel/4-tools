...
window.addEventListener("load",() => {
    ...
    if (JSON.parse(atob(fs.readFileSync(path.join(sysVariable.userData, "clients"), "utf-8")))["password"] === "UNSPA") {
    ...
    document.getElementById("login").addEventListener("submit",(e) => {
        ...
        let client = JSON.parse(atob(fs.readFileSync(path.join(sysVariable.userData, "clients"),"utf-8")));
